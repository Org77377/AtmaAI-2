      ...
      <Card className="shadow-xl">
        <CardHeader className="text-center">
          <div className="flex items-center justify-center gap-3 mb-2">
            ...
            <CardTitle className="text-3xl md:text-4xl">Friendly Chat with Aatme</CardTitle>
          </div>
          <CardDescription className="text-lg">
            Share your thoughts or concerns, and let Aatme offer a supportive ear and a fresh perspective to help you navigate challenges.
          </CardDescription>
        </CardHeader>
        <CardContent>
