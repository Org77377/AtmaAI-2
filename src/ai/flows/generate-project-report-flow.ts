...
const prompt = ai.definePrompt({
  ...
  3.  **Length based on Report Type:**
      ...
      *   If 'detailed': Aim for a comprehensive report, potentially 10-20 pages (e.g., 5000-10000 words). Expand on all sections, provide more in-depth analysis, more detailed implementation descriptions, and a more thorough literature review.
  4.  **Formatting:**
