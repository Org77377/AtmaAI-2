...
const prompt = ai.definePrompt({
  ...
  1.  **Structure:** Generate a well-structured project report. Common sections include (but are not limited to, adapt as necessary for the topic):
      ...
      *   7. References / Bibliography (list any sources cited or used, in a consistent format like APA or IEEE if possible, otherwise a clear list).
  2.  **Content Quality:**
  ...
  3.  **Length based on Report Type:**
      ...
      *   If 'detailed': Aim for a **highly comprehensive and in-depth report**, potentially 10-20 pages (e.g., 5000-10000 words). **Significantly expand on all sections**. Provide extensive details in the Introduction (deeper background, refined problem statement, very clear objectives and scope). The Literature Review must be thorough, discussing multiple relevant existing works, comparing them, and identifying gaps. The Methodology section should detail the research design, data collection methods, tools, and analytical techniques comprehensively. The System Design / Implementation / Development section must offer granular details of the architecture, algorithms, code structure (if applicable), and challenges faced during development. The Results and Discussion / Findings section needs to present detailed results, robust analysis, interpretation of findings in the context of the objectives, and comparison with existing literature. The Conclusion should summarize key findings meticulously, discuss limitations in detail, and propose extensive and specific future work.
  4.  **Formatting:**
