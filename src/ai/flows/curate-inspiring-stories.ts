...
/**
 * @fileOverview AI agent that curates inspiring real-life stories based on user profiles and challenges.
 *
...
const CurateInspiringStoriesOutputSchema = z.object({
  stories: z
    .array(z.string())
    .describe('An array of inspiring real-life stories relevant to the user.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI assistant designed to provide inspiring and relevant real-life stories to users based on their profile and current challenges.

  User Profile: {{{userProfile}}}
  Current Challenges: {{{currentChallenges}}}

  Based on the user's profile and challenges, curate a list of 3-5 inspiring real-life stories that could provide motivation and guidance. Each story should be a short paragraph summarizing the key points and inspirational aspects of the story.
